...
func dellChassisSetup() (r *DellCmcReader, err error) {
	...
	r, err = NewDellCmcReader(&ip, &username, &password)
	if err != nil {
		return r, err
	}
...
func dellChassisTeardown() {
	server.Close()
}

func TestDellChassisFwVersion(t *testing.T) {
	expectedAnswer := "6.00"
...
func TestDellChassisPassThru(t *testing.T) {
	expectedAnswer := "10G"
...
func TestDellChassisSerial(t *testing.T) {
...
func TestDellChassisModel(t *testing.T) {
...
func TestDellChassisName(t *testing.T) {
...
func TestDellChassisStatus(t *testing.T) {
	expectedAnswer := "OK"
...
func TestDellChassisPowerKW(t *testing.T) {
...
func TestDellChassisTempC(t *testing.T) {
	expectedAnswer := 17
...
func TestDellChassisNics(t *testing.T) {
