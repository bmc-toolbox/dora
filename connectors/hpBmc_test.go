...
var (
	hpIloAnswers = map[string][]byte{
		...
		"/json/overview":           []byte(`{"server_name":"bbmi","product_name":"ProLiant DL380 Gen9","serial_num":"CZ3605020D","virtual_serial_num":null,"product_id":"719064-B21","uuid":"30393137-3436-5A43-3336-303530323044","virtual_uuid":null,"system_rom":"P89 v2.42 (04/25/2017)","system_rom_date":"04/25/2017","backup_rom_date":"09/13/2016","license":"iLO Advanced","ilo_fw_version":"2.54 Jun 15 2017","ilo_fw_bootleg":"","nic":0,"ip_address":"10.193.251.54","ipv6_link_local":"FE80::9657:A5FF:FE60:AACA","system_health":"OP_STATUS_OK","uid_led":"UID_OFF","power":"ON","date":"Thu Nov  2 10:56:58 2017","https_port":443,"ilo_name":".example.com","removable_hw":[{"tpm_status":"NOT_PRESENT","module_type":"UNSPECIFIED","sd_card":"NOT_PRESENT"}],"option_ROM_measuring":"Disabled","has_reset_priv":1,"chassis_sn":"","isUEFI":1,"ers_state":"ERS_INACTIVE"}`),
...
func hpIloSetup() (bmc *IloReader, err error) {
	...
	for url := range hpIloAnswers {
		url := url
		mux.HandleFunc(url, func(w http.ResponseWriter, r *http.Request) {
			w.Write(hpIloAnswers[url])
		})
	}

	bmc, err = NewIloReader(&ip, &username, &password)
	if err != nil {
		return bmc, err
	}
...
func TestHpIloSerial(t *testing.T) {
	expectedAnswer := "cz3605020d"

	bmc, err := hpIloSetup()
	if err != nil {
		t.Fatalf("Found errors during the test hpIloSetup %v", err)
	}
...
func TestHpIloModel(t *testing.T) {
...
func TestHpIloBmcType(t *testing.T) {
	expectedAnswer := "iLO4"
...
func TestHpIloBmcVersion(t *testing.T) {
	expectedAnswer := "2.54"
...
func TestHpIloName(t *testing.T) {
	expectedAnswer := "bbmi"
...
func TestHpIloStatus(t *testing.T) {
	expectedAnswer := "OK"
...
func TestHpIloMemory(t *testing.T) {
	expectedAnswer := 96
...
func TestHpIloBiosVersion(t *testing.T) {
...
func TestHpIloPowerKW(t *testing.T) {
...
func TestHpIloTempC(t *testing.T) {
	expectedAnswer := 13
...
func TestHpIloNics(t *testing.T) {
...
func TestHpIloLicense(t *testing.T) {
...
func TestHpIloIsBlade(t *testing.T) {
